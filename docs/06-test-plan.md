...
| `test_wif_checksum_valid` | Any valid key | Base58-decode the WIF; last 4 bytes match double-SHA256 of the payload, and the payload is `0x80` prefix, key bytes, `0x01` compression flag |
